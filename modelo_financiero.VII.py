...
# ══════════════════════════════════════════════════════════════
# 3.  CONSTANTES BASE (calculadas dinámicamente desde run_model)
# ══════════════════════════════════════════════════════════════

_BASE        = run_model()          # caso base sin sensibilidades
MIRR_BASE    = _BASE["mirr"]        # 23.3002%  exacto del xlsx
VAN_BASE     = _BASE["van"]         # 47,639,480,891.14 exacto
VAFF_VAE_BASE = _BASE["vaff_vae"]   # 0.26242556 exacto
